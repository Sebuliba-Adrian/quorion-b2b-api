...
class TenantAddressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TenantAddress
        fields = ['id', 'tenant', 'tenant_name', 'address_type', 'address1', 'address2',
                 'city', 'state', 'zip_code', 'country', 'is_active', 'created_at', 'updated_at']
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class TenantAssociationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'seller', 'seller_name', 'buyer', 'buyer_name',
                 'storefront_id', 'is_active', 'created_at', 'updated_at']
        read_only_fields = ['id', 'created_at', 'updated_at']
