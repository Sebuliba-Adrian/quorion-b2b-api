...
from commerce.models import (Lead, QuoteRequest, QuoteRequestDetail, PurchaseOrder,
...
def product(seller):
    return Product.objects.create(
        seller=seller,
        name='Test Product',
        brand_product_name='Brand Test Product',
        status='published'
    )
...
class TestQuoteFlow:
    ...
    def test_create_quote(self, api_client, buyer, seller, buyer_warehouse,
                         delivery_term, payment_term, payment_mode, product, sku):
    ...
    def test_add_items_to_quote(self, api_client, buyer, seller, buyer_warehouse,
                                delivery_term, payment_term, payment_mode, product, sku):
        # Create quote
    ...
    def test_buyer_requests_quote(self, api_client, buyer, seller, buyer_warehouse,
                                 delivery_term, payment_term, payment_mode, product, sku):
    ...
    def test_seller_responds_with_pricing(self, api_client, buyer, seller, buyer_warehouse,
                                         delivery_term, payment_term, payment_mode, product, sku):
        ...
        data = {
            'items': [
                {'id': str(item.id), 'price_per_unit': '50.00'}
            ],
    ...
    def test_price_tier_resolution(self, api_client, buyer, seller, buyer_warehouse,
                                   delivery_term, payment_term, payment_mode, product, sku):
        # Create price tier
    ...
    def test_buyer_accepts_quote_creates_order(self, api_client, buyer, seller, buyer_warehouse,
                                               delivery_term, payment_term, payment_mode, product, sku):
...
class TestOrderFlow:
    ...
    def test_accept_order(self, api_client, buyer, seller, buyer_warehouse,
                         delivery_term, payment_term, payment_mode, product, sku):
        # Create order
    ...
    def test_order_fulfillment_flow(self, api_client, buyer, seller, buyer_warehouse,
                                    delivery_term, payment_term, payment_mode, product, sku):
    ...
    def test_create_shipment_advice(self, api_client, buyer, seller, buyer_warehouse,
                                    delivery_term, payment_term, payment_mode, product, sku):
...
class TestEndToEndFlow:
    ...
    def test_complete_flow(self, api_client, seller, buyer, buyer_warehouse,
                          delivery_term, payment_term, payment_mode, product, sku):
        # 1. Create lead
        lead = Lead.objects.create(
            seller=seller,
...
class TestErrorCases:
    ...
    def test_quote_cancel(self, api_client, buyer, seller, buyer_warehouse,
    ...
    def test_quote_seller_declines(self, api_client, buyer, seller, buyer_warehouse,
                                  delivery_term, payment_term, payment_mode):
        quote = QuoteRequest.objects.create(
            buyer=buyer,
            seller=seller,
    ...
    def test_quote_seller_modifies(self, api_client, buyer, seller, buyer_warehouse,
                                   delivery_term, payment_term, payment_mode):
        quote = QuoteRequest.objects.create(
            buyer=buyer,
            seller=seller,
    ...
    def test_quote_buyer_responds(self, api_client, buyer, seller, buyer_warehouse,
                                  delivery_term, payment_term, payment_mode):
        quote = QuoteRequest.objects.create(
            buyer=buyer,
            seller=seller,
    ...
    def test_quote_item_auto_price_resolution(self, api_client, buyer, seller, buyer_warehouse,
                                              delivery_term, payment_term, payment_mode, product, sku):
        # Create price tier
        price_tier = PriceTier.objects.create(
            seller=seller,
    ...
    def test_order_perform_create(self, api_client, buyer, seller, buyer_warehouse,
                                  delivery_term, payment_term, payment_mode):
    ...
    def test_order_cancel(self, api_client, buyer, seller, buyer_warehouse,
                          delivery_term, payment_term, payment_mode):
        order = PurchaseOrder.objects.create(
            buyer=buyer,
            seller=seller,
    ...
    def test_quote_detail_str_method(self, buyer, seller, buyer_warehouse, delivery_term, 
                                    payment_term, payment_mode, product, sku):
        quote = QuoteRequest.objects.create(
            buyer=buyer,
            seller=seller,
            warehouse=buyer_warehouse,
    ...
    def test_order_detail_str_method(self, buyer, seller, buyer_warehouse, delivery_term,
                                     payment_term, payment_mode, product, sku):
        order = PurchaseOrder.objects.create(
            buyer=buyer,
            seller=seller,
    ...
    def test_shipment_str_method(self, buyer, seller, buyer_warehouse, delivery_term,
                                payment_term, payment_mode):
        order = PurchaseOrder.objects.create(
            buyer=buyer,
            seller=seller,
            warehouse=buyer_warehouse,
        ...
        shipment = ShipmentAdvice.objects.create(
            order=order,
            carrier='FedEx',
            carrier_number='TRACK123'
        )
        assert 'PO-SHIP-001' in str(shipment)
    
    def test_price_tier_str_method(self, seller, buyer, buyer_warehouse, delivery_term,
                                   payment_term, product, sku):
        price_tier = PriceTier.objects.create(
            seller=seller,
            buyer=buyer,
            destination=buyer_warehouse,
    ...
    def test_quote_detail_get_price_no_sku(self, buyer, seller, buyer_warehouse, delivery_term,
                                          payment_term, payment_mode, product):
        quote = QuoteRequest.objects.create(
            buyer=buyer,
            seller=seller,
            warehouse=buyer_warehouse,
    ...
    def test_seller_responds_invalid_item_id(self, api_client, buyer, seller, buyer_warehouse,
                                            delivery_term, payment_term, payment_mode):
        quote = QuoteRequest.objects.create(
            buyer=buyer,
            seller=seller,
        ...
        data = {
            'items': [
                {'id': '00000000-0000-0000-0000-000000000000', 'price_per_unit': '50.00'}
            ],
            'shipping_cost': '100.00'
        }
        response = api_client.post(url, data, format='json')
    ...
    def test_accept_by_distributor_with_parent_forwarded(self, api_client, seller, distributor):
        ...
        parent_lead = Lead.objects.create(
            seller=seller,
            buyer_first_name='John',
            buyer_email='john@buyer.com'
        )
