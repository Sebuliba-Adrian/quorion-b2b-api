...
class ProductSKUSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProductSKU
        fields = ['id', 'product', 'product_name', 'distributor', 'distributor_name',
                 'buyer', 'number', 'name', 'kind', 'packaging_type', 'packaging_type_name',
                 'packaging_unit', 'packaging_unit_name', 'package_volume', 'is_active',
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'seller', 'seller_name', 'name', 'description', 'brand_product_name',
                 'status', 'is_active', 'skus', 'created_at', 'updated_at']
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class ListPriceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ListPrice
        fields = ['id', 'sku', 'sku_number', 'price', 'currency', 'is_active',
                 'created_at', 'updated_at']
        read_only_fields = ['id', 'created_at', 'updated_at']
